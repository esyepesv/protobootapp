...
//Se lanza y se ejecuta con http://localhost:8081 o la URL específica al proveedor cloud
...
public class ProtobootappApplication {
    ...
    //Se ejecuta con http://localhost:8081/
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido! Esta aplicación ayuda a elevar números a sus potencias.");
    }    

    //Se ejecuta con http://localhost:8081/hola o http://localhost:8081/hola?nombre=John
    @GetMapping("/hola")
    public String hola(@RequestParam(value = "nombre", defaultValue = "Mundo") String nombre) {
        return String.format("Hola %s!", nombre);
    }
    
    //Se ejecuta con http://localhost:8081/cuadrado o http://localhost:8081/cuadrado?numero=5
    @GetMapping("/cuadrado")
    ...
    //Se ejecuta con http://localhost:8081/cubo o http://localhost:8081/cubo?numero=5
    @GetMapping("/cubo")
